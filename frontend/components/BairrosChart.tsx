...
export default function BairrosChart({ data }: { data: BairroData[] }) {
  // ✅ PALETA IFOOD LOGÍSTICA: Tons de vermelho para mapeamento de calor
  ...
  return (
    // ✅ ESTRUTURA ELÁSTICA: Garante que ocupe perfeitamente o grid do page.tsx sem esticar
    <div className="flex-1 flex flex-col min-h-0 w-full group">
              ...
              tick={(props) => {
                ...
                return (
                  <g transform={`translate(${x},${y})`}>
                    ...
                    >
                      {/* Truncagem aumentada para 18 caracteres */}
      ...
      {/* Footer informativo - shrink-0 garante presença constante */}
